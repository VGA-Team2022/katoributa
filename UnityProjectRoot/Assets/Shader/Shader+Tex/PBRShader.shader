Shader "TK/Material/PBRShader"
{
    Properties
    {
        ...
        _UseAddColorLevel("UseAddColorLevel", Range(0,1)) = 0
        [HDR]_AddColor("AddHDRColor", Color) = (0, 0, 0, 0)
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature _ UseAddColorToggle_ON
            ...
            half4 frag(Varyings input) : SV_Target
            {
                ...
                color += _AddColor * _UseAddColorLevel;
